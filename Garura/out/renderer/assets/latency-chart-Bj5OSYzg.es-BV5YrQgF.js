import { r as reactExports, R as React, j as jsxRuntimeExports } from "./index-B8irP8jm.js";
/*!
 * @kurkle/color v0.3.4
...
Chart$1.register(CategoryScale, LinearScale, LineElement, PointElement);
const CallStatsLatencyChart = (props) => {
  ...
  const options = reactExports.useMemo(() => getLineOptions(max), [max]);
  return jsxRuntimeExports.jsx("div", { className: "str-video__call-stats-line-chart-container", children: jsxRuntimeExports.jsx(Line, { options, data, className: "str-video__call-stats__latencychart" }) });
};
